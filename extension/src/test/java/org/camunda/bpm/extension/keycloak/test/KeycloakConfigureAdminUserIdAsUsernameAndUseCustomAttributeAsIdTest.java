 ...
 */
public class KeycloakConfigureAdminUserIdAsUsernameAndUseCustomAttributeAsIdTest extends AbstractKeycloakIdentityProviderTest {

	public static Test suite() {
	    return new TestSetup(new TestSuite(KeycloakConfigureAdminUserIdAsUsernameAndUseCustomAttributeAsIdTest.class)) {
