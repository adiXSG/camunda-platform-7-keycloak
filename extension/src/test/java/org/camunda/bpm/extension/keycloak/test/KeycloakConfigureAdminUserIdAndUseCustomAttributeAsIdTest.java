 ...
 */
public class KeycloakConfigureAdminUserIdAndUseCustomAttributeAsIdTest extends AbstractKeycloakIdentityProviderTest {

	public static Test suite() {
	    return new TestSetup(new TestSuite(KeycloakConfigureAdminUserIdAndUseCustomAttributeAsIdTest.class)) {
			...
			protected void setUp() throws Exception {
	    		ProcessEngineConfigurationImpl config = (ProcessEngineConfigurationImpl) ProcessEngineConfiguration
						.createProcessEngineConfigurationFromResource(
								"camunda.configureAdminUserIdAsUsernameAndUseCustomAttributeAsId.cfg.xml");
	...
	public void testAdminUserConfiguration() {
		...
		assertEquals(CUSTOM_ATT_CAMUNDA_ADMIN, adminUserId);
		...
		assertNotNull(user);
		assertEquals(CUSTOM_ATT_CAMUNDA_ADMIN, user.getId());
