...
/**
 * Immutable wrapper over KeycloakTenantQuery that can be used as a cache key. Note: keep equals/hashcode in sync with the list of fields
 */
public class CacheableKeycloakTenantQuery {
	...
	public boolean equals(Object o) {
		...
		return Objects.equals(id, that.id) && Arrays.equals(ids, that.ids) && Objects.equals(name, that.name)
				&& Objects.equals(nameLike, that.nameLike) && Objects.equals(userId, that.userId) && Objects.equals(groupId, that.groupId);
	}
